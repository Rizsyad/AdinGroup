...
<head>
  ...
  <title>Pemesanan | Daftar Menu</title>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="#">Daftar Menu</a>
          </li>
          <li class="nav-item">
      ...
      <div class="row">
        <div class="col-md-3 mb-3">
            <div class="card" style="width: 18rem;">
                <img src="<?=base_url('product/product01.jpeg')?>" class="card-img-top" width="200px" height="200px">
                <div class="card-body">
