    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item ">
            <a class="nav-link active" aria-current="page" href="#">Pesanan Anda</a>
          </li>
          <li class="nav-item">
  ...
  <div class="container">
      ...
      <div class="row mb-5 mt-5">
        <div class="col-md-6 d-flex justify-content-end">
            <a href="#" class="btn btn-primary">Lihat daftar Menu</a>
        </div>
    ...
    <!-- <div class="row mb-5 mt-5 container mx-auto text-center">
        <div class="col-md-2">
            <button class="btn btn-primary">Lihat daftar Menu</button>
        </div>
        <div class="col-md-2">
